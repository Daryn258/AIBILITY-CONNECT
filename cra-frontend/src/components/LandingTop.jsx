...
import blob from "../assests/disable.jpeg";
    ...
    <>
      <div className="home-container" style={{ position: "relative" }}>
        ...
        <div className="flexup">
          ...
          >
            ...
            Begin Your Path to a Rewarding Career Today.
            </p>
            <img className="home-image" src={blob} alt="profile" />
          </div>
        </div>
        <div className="home-content-below-title">
        We recognize the distinct strengths and talents that individuals with <br/>
         disabilities contribute to the workforce.
        </div>
        <div className="buttons">
          <a
            href="https://calendly.com/monteirodaryn"
          ...
          <a
            href="https://maps.app.goo.gl/2EueABiBx5R9JCTy8"
            className="btn btn2"
            style={{ textDecoration: "none" }}
          >
            Visit Us
      ...
      <div className="company">
        <p className="p2">
          ...
          <span style={{ color: "#2234da" }}> 200 + </span>Companies
          Worldwide
        </p>
        <div className="block-companies">
          <div className="comapanies">HDFC</div>{" "}
          <span className="slash" style={{ color: "#2234da" }}>
            |
          </span>
          <div className="comapanies">Amazon</div>
          <span className="slash" style={{ color: "#2234da" }}>
            |
          </span>
          <div className="comapanies">Nestle</div>
          <span className="slash" style={{ color: "#2234da" }}>
            |
          </span>
          <div className="comapanies">Flipkart</div>
          <span className="slash" style={{ color: "#2234da" }}>
            |
          </span>
          <div className="comapanies">Google</div>
        </div>
      </div>
      <div className="section1" style={{ position: "relative" }}>
        ...
        <p className="section-title">
          Realize Your Potential. Thrive in Your Career <br />
          with Inclusive Employment Opportunities!
        </p>
        <p className="subheading">
        Find Your Way. Confidently Navigate Your Career with Tailored Job Matches.
        </p>
        <p className="subheading" id="2" style={{ marginTop: "-15px" }}>
        Empowering Support. Championing Accessibility. Embracing Inclusive Employment.
        </p>
